...
VALUES ('bestchange', 'buy', 'https://bestchange.app/?lang=en', 'BestChange Buy', ARRAY['BYN', 'EUR', 'RUB', 'USD']::TEXT[], ARRAY[]::TEXT[], '{}'::JSONB, '{}'::JSONB, 'bestchange/Providerfile')
...
INSERT INTO providers (slug, operation, source_url, name, currencies, banks, adapter, workflow, source_file)
VALUES ('bestchange', 'sell', 'https://bestchange.app/?lang=en', 'BestChange Sell', ARRAY['BYN', 'EUR', 'RUB', 'USD']::TEXT[], ARRAY[]::TEXT[], '{}'::JSONB, '{}'::JSONB, 'bestchange/Providerfile')
ON CONFLICT (slug, operation) DO UPDATE SET
source_url = EXCLUDED.source_url,
name = EXCLUDED.name,
currencies = EXCLUDED.currencies,
